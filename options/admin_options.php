...
array( "name" => "Endere&ccedil;o",
	"desc" => "Adicione o endere&ccedil;o da empresa",
	"id" => $shortname."_endereco",
	"type" => "text",
	"std" => ""),
	
array( "name" => "Bairro",
	"desc" => "Adicione o bairro da empresa",
	"id" => $shortname."_bairro",
	"type" => "text",
	"std" => ""),	

array( "name" => "Cidade",
	"desc" => "Adicione a cidade da empresa",
	"id" => $shortname."_cidade",
	"type" => "text",
	"std" => ""),	
	
array( "name" => "Telefone",
	"desc" => "Adicione o telefone da empresa",
	"id" => $shortname."_telefone",
	"type" => "text",
	"std" => ""),
	
	array( "name" => "Email",
	"desc" => "Adicione o email da empresa",
	"id" => $shortname."_email",
	"type" => "text",
	"std" => ""),
